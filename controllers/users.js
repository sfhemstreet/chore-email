...
const forgotPassword = (req,res,sgMail) => {
    token.checkToken(req).then(isValid => {
        ...
        const htmlVersion = template.emailTemplate('Chore - Forgot Password',emailText, 'Click Here',`${process.env.FRONTEND_URL}resetpassword/${string}`,'Lets reset your Chore password');
